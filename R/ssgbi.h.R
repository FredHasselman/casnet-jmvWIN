...
ssgBIOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "ssgBIOptions",
...
ssgBIResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "ssgBIResults",
...
ssgBIBase <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "ssgBIBase",
