...
ssgUNIOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "ssgUNIOptions",
...
ssgUNIResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "ssgUNIResults",
...
ssgUNIBase <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "ssgUNIBase",
