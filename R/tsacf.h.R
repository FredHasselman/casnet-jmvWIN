...
tsACFOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "tsACFOptions",
...
tsACFResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "tsACFResults",
...
tsACFBase <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "tsACFBase",
